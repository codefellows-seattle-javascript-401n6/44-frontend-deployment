...
/***/ "../../../../.nvm/versions/node/v8.2.0/lib/node_modules/webpack/buildin/harmony-module.js":
/*!*******************************************!*\
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../../../../.nvm/versions/node/v8.2.0/lib/node_modules/webpack/buildin/global.js */ "../../../../.nvm/versions/node/v8.2.0/lib/node_modules/webpack/buildin/global.js"), __webpack_require__(/*! ./../../../../../../../.nvm/versions/node/v8.2.0/lib/node_modules/webpack/buildin/harmony-module.js */ "../../../../.nvm/versions/node/v8.2.0/lib/node_modules/webpack/buildin/harmony-module.js")(module)))
...
/***/ "./src/actions/spot-it-actions.js":
/*!****************************************!*\
  !*** ./src/actions/spot-it-actions.js ***!
  \****************************************/
/*! no static exports found */
...
exports.listsLoad = listsLoad;
exports.listsPoint = listsPoint;
var LISTS_LOAD = exports.LISTS_LOAD = 'LISTS_LOAD';
var LISTS_POINT = exports.LISTS_POINT = 'LISTS_POINT';
function listsLoad(json) {
  return { type: LISTS_LOAD, json: json };
};
function listsPoint() {
...
var _dashboard = __webpack_require__(/*! ./dashboard */ "./src/components/dashboard.js");
...
var _spotItActions = __webpack_require__(/*! ../actions/spot-it-actions */ "./src/actions/spot-it-actions.js");
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h1',
          null,
          'Find the words that are in both sets'
        ),
        _react2.default.createElement(
          'div',
          null,
          'Score: ',
          this.props.lists.score
        ),
        _react2.default.createElement(_list2.default, { info: this.props.lists.list1 }),
        _react2.default.createElement(_list2.default, { info: this.props.lists.list2 })
      );
    }
  }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, getState) {
  return {
    listsLoad: function listsLoad() {
      dispatch((0, _spotItActions.listsLoad)());
    }
  };
};
...
var ListItem = function (_React$Component) {
  ...
  function ListItem(props) {
    ...
    _this.checkMatch = function (event) {
      event.preventDefault();
      var targetVal = event.target.innerText;
      var commonWord = _this.props.lists.commonWord;

      if (targetVal === commonWord) {
        _this.props.listsPoint();
        _this.props.listsLoad();
      }
    };
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, getState) {
  return {
    listsPoint: function listsPoint() {
      return dispatch((0, _spotItActions.listsPoint)());
    },
    listsLoad: function listsLoad() {
      return dispatch((0, _spotItActions.listsLoad)());
    }
  };
};
...
var _listItem = __webpack_require__(/*! ./list-item */ "./src/components/list-item.js");
...
var List = function (_React$Component) {
  ...
  function List(props) {
    ...
    _this.displayNewSet = function () {
      return _this.props.info.map(function (listItem, i) {
        return _react2.default.createElement(_listItem2.default, { key: i, info: listItem });
      });
    };
...
var _spotIt = __webpack_require__(/*! ./spot-it */ "./src/reducers/spot-it.js");
...
exports.default = (0, _redux.combineReducers)({
  lists: _spotIt2.default
});

/***/ }),

/***/ "./src/reducers/spot-it.js":
/*!*********************************!*\
  !*** ./src/reducers/spot-it.js ***!
  \*********************************/
/*! no static exports found */
...
var initialState = {
  score: 0,
  allWords: ['flower', 'garden', 'ball', 'key', 'frog', 'apple', 'ice', 'grass', 'crown', 'eyeball', 'dress', 'shoes', 'icecream', 'skateboard', 'car', 'lipstick', 'hairbrush', 'princess', 'castle', 'tire', 'hammer', 'door', 'window', 'skates', 'sandals', 'flipflops', 'tree', 'rose', 'milkshake', 'dog', 'cat', 'milk', 'cow', 'farm', 'fence', 'road', 'snowman', 'snowflake', 'cloud', 'sun', 'juice', 'glass', 'apron', 'knife', 'fork', 'spot', 'coat', 'raindrop', 'love', 'planet', 'hat', 'burger', 'banana', 'TV', 'computer', 'CodeFellows'],
  list1: [],
  list2: [],
  commonWord: ''
};

function wordCardReducer(state, action) {
  if (state === undefined) {
    return initialState;
  }
  ...
  switch (action.type) {
    case _spotItActions.LISTS_LOAD:
      var newList1 = [];
      var newList2 = [];
      var usedWords = [];

      for (var i = 0; i < 7; i++) {
        var randomIndex1 = Math.floor(Math.random() * initialState.allWords.length);
        var randomIndex2 = Math.floor(Math.random() * initialState.allWords.length);
        var randomWord1 = initialState.allWords[randomIndex1];
        var randomWord2 = initialState.allWords[randomIndex2];
      ...
      var commonIndex = Math.floor(Math.random() * initialState.allWords.length);
      var commonWord = initialState.allWords[commonIndex];

      while (usedWords.indexOf(commonWord)) {
      ...
      newList1.sort(function () {
        0.5 - Math.random();
      });
      newList2.sort(function () {
        0.5 - Math.random();
      });
    ...
    case _spotItActions.LISTS_POINT:
...
exports.default = wordCardReducer;
