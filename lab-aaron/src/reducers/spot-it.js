...
let initialState = {
  score: 0,
  allWords: [
    'flower', 'garden', 'ball', 'key', 'frog', 'apple', 'ice', 'grass', 'crown', 
    'eyeball', 'dress', 'shoes', 'icecream', 'skateboard', 'car', 'lipstick', 'hairbrush', 
    'princess', 'castle', 'tire', 'hammer', 'door', 'window', 'skates', 'sandals', 'flipflops', 
    'tree', 'rose', 'milkshake', 'dog', 'cat', 'milk', 'cow', 'farm', 'fence', 'road', 'snowman', 
    'snowflake', 'cloud', 'sun', 'juice', 'glass', 'apron', 'knife', 'fork', 'spot', 'coat', 
    'raindrop', 'love', 'planet', 'hat', 'burger', 'banana', 'TV', 'computer', 'CodeFellows'
  ],
  list1: [],
  list2: [],
  commonWord: '',
